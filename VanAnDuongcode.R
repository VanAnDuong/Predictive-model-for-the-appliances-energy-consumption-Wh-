#Van An Duong 
#Task 1
the.data <- as.matrix(read.table("ENB_2023.txt")) #Assign data to a matrix
num_row = 400 # Limit the quantity of record as the requirement
num_col <- ncol(the.data) #Number columns of the.data
num_samples <- nrow(the.data) #Number rows of the.data
